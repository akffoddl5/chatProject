...
<body>
	<div id="page" class="container">
		<div id="header">
			<div id="logo">
				<img src="resources/images/${vo.thumbnailPath }"
			...
			<div id="menu">
				<ul>
					...
					<li><a href="bannedFriends.go" accesskey="4" title="">Banned
							Friends</a></li>
					<li class="current_page_item"><a href="myProfile.go"
						accesskey="5" title="">My Profile</a></li>
				</ul>
			</div>
		</div>
		<div id="main">
